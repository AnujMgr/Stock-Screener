  ...
  return (
    <div className="opacity-95 sticky top-0 shadow-md border-b-1 bg-white dark:bg-gray-700   z-30 grid border-t dark:border-gray-600">
      <div className="xl:container mx-auto flex items-center overflow-x-auto custom-scroll no-scroll w-full">
        <div
          className={`dark:text-white text-gray-900 px-3 py-2 hover:border-indigo-700 transition duration-500 ease-in-out border-transparent border-b-2 flex-grow-0 inline-flex items-center flex-none
          ${
            router.asPath === `/company/${slug}`
              ? "border-indigo-700 dark:border-indigo-600"
              : ""
          }
          `}
        >
        ...
        <div className="dark:text-white text-gray-900 px-3 py-2 hover:border-indigo-700  transition duration-500 ease-in-out border-transparent border-b-2 flex-grow-0 inline-flex items-center flex-none">
